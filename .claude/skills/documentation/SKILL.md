---
name: documentation
description: Generate or update documentation for changed or specified code. Adds Javadoc, README sections, or inline comments following project conventions. Use when asked to document a class, method, or changes.
allowed-tools: Read, Edit, Glob, Grep, Bash
---

# Documentation Skill

> **Canonical runbook**: `.ai/skills/documentation.md`
...
> should be made in `.ai/skills/documentation.md` first.
...
- Use `@throws` for each declared checked exception, and for unchecked exceptions callers must handle.
...
- Never alter logic or rename identifiers — documentation changes only
